...
Ammo().then((Ammo) => {
    ...
    function loadRyanText() {
        ...
        text_loader.load('./src/jsm/STZhongsong_Regular.json', function(font) {
            ...
            var geometry = new THREE.TextGeometry("五阿哥不上朝", {
                font: font,
                size: 3,
                height: 0.5,
                curveSegments: 12,
    ...
    function loadEngineerText() {
        ...
        text_loader.load('./src/jsm/Poppins_Regular.json', function(font) {
            ...
            var geometry = new THREE.TextGeometry('Loving life', {
                font: font,
                size: 1.5,
                height: 0.5,
                curveSegments: 20,
    ...
    function createBillboardRotated(
        ...
        const billboardPoleScale = { x: 1, y: 4, z: 1 };
        ...
        billboardPole.position.x = x;
        billboardPole.position.y = y - 1;
        billboardPole.position.z = z;

        billboardSign.position.x = x;
        billboardSign.position.y = y + 11;
        billboardSign.position.z = z;
    ...
    function start() {
        ...
        Words(1.2, 1, -20);
        // 提示文字
        createTextOnPlane(-70, 0.01, -48, inputText.one, 20, 40);
        createTextOnPlane(-42, 0.01, -48, inputText.two, 20, 40);
        createTextOnPlane(-14, 0.01, -48, inputText.thr, 20, 40);
        ...
        // 浮动文字
        floatingLabel(10, 4.5, -70, 'Github');
        floatingLabel(18, 4.5, -70, 'BiliBili');
        floatingLabel(26, 4.5, -70, 'Email');
        floatingLabel(34, 4.5, -70, 'QQ');

        // 图片贴图
        allSkillsSection(-50, 0.025, 20, 40, 40, boxTexture.allSkills);
        allSkillsSection(61, 0.025, 13, 30, 60, inputText.activities);
        allSkillsSection(12, 0.025, 54, 7, 3.5, boxTexture.skrillex);
        ...
        allSkillsSection(21.5, 0.01, -60, 20, 10, inputText.link);

        // 板块文字
        simpleText(-50, 0.01, -5, 'SKILLS', 3);
        simpleText(-42, 0.01, -30, 'HOBBY', 3);
